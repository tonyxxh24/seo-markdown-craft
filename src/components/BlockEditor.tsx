    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <Input
          ...
          className="flex-1 text-lg font-semibold border-2 border-blue-200 focus:border-blue-500"
          placeholder="區塊名稱"
        />
        <Button
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white shadow-md hover:shadow-lg transition-all duration-300"
          >
